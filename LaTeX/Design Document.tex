...
\section{RTL and Datapath}
	...
	\subsection{Summary Charts - RTL and Datapath}
			\begin{center} \begin{tabular}{| c | c | c | c | c | c | c | c |} \hline
				...
				\thead{Decode} & \multicolumn{7}{c|}{\thead{if(IR[15:12]==0x1) PC++ \\ ALUout ::= PC + SE(IR[3:0])}} \\ \hline
				\thead{Do \\ computation} & \thead{ALUout::=reg\#IR[11:8]\\aluop reg\#IR[7:4]} & \thead{if(reg\#IR[11:8] aluop\\reg\#IR[7:4] == 0) \\ PC ::= ALUout} & \multicolumn{2}{c|}{\thead{ALUout ::= reg\#IR[7:4] + SE(IR[3:0])}} & \thead{SchLatch\\::= IR[3:0]} & \thead{Change\\on\\Code\#} & \thead{PC::=reg\#IR[11:8]\\+SE(IR[7:0]$<<$1)} \\ \hline
