...
\section{RTL}
	...
	\subsection{Summary Chart}
		\begin{center} \begin{tabular}{| c | c | c | c | c | c | c | c |} \hline
			...
			\thead{Do \\ computation} & \thead{ALUout = \\ R0 $\dagger$ R1} & \thead{PCtemp = ALUout \\ ALUout = R0 $\dagger$ R1} & \multicolumn{2}{c|}{\thead{ALUout = \\ R1 + SE(Hreg$<<$1)}} & \thead{SchLatch\\= Hreg} & \thead{Change\\on Code\#} & \thead{PC = R0\\+ IR[7:0]} \\ \hline
