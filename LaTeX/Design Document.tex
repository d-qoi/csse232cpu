	...
	\subsection{Instruction Types and Bit Layouts}
		...
		\subsubsection{H-Type}
			...
			\begin{center}
				\begin{tabular}{l r l r l r l r}
					\hline
					\multicolumn{2}{| p{2cm} |}{OP Code} & \multicolumn{2}{p{2cm}}{ } & \multicolumn{2}{p{1.5cm}}{ } & \multicolumn{2}{| p{2.5cm} |}{Group} \\ \hline
					15 & 12 & & & & & 4 & 0
				\end{tabular}
			\end{center}
