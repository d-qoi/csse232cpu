		...
		\subsubsection{Schwap Group Numbers, Descriptions, and Uses}
			\begin{center}
				\begin{tabular}{| c | c | c | c |} \hline
					...
					\multirow{4}{*}{14} & 0 & Exception Cause        & -  \\ \cline{2-4}
								 & 1     & Exception Status          & -  \\ \cline{2-4}
								 & 2     & EPC                       & -  \\ \cline{2-4}
								 & 3     & Exception Temporary       & -  \\ \hline
					15           & 0 - 3 & Illuminati Reserved       & -  \\ \hline
				\end{tabular} \\
			\end{center}
\section{Instructions}
		...
		\subsubsection{H-Type}
			\begin{center} \begin{tabular}{| c | c | l | c |} \hline
				\thead{OP \\ Code} & Name & Syntax & Description \\ \hline
				 0xD & scp  & scp [bullshit]& \thead{No fucking clue what this is, \\ I just remember you guys talking about it}\\ \hline
	...
	\subsection{Sudo}
		...
		\begin{center} \begin{tabular}{| c | c |} \hline
			...
			sudo 69 & \thead{HEY FUCKERS, MORE SHIT NEEDS TO GO HERE}\\ \hline
		\end{tabular} \end{center}
\section{RTL and Datapath}
	...
	\subsection{Summary Charts - RTL and Datapath}
			\begin{center} \begin{tabular}{| c | c | c | c | c | c | c | c |} \hline
				...
				\thead{Execute} & \thead{ALUout::=reg\#IR[11:8]\\aluop reg\#IR[7:4]} & \thead{if(reg\#IR[11:8] aluop\\reg\#IR[7:4] == 0) \\ PC ::= ALUout} & \multicolumn{2}{c|}{\thead{ALUout ::= reg\#IR[7:4] + SE(IR[3:0])}} & \thead{SchLatch\\::= IR[3:0]} & \thead{Change\\on\\Code\#} & \thead{PC::=reg\#IR[11:8]\\+SE(IR[7:0]$<<$1)} \\ \hline
...
\section{The C$\flat$ Programming Language and compiler}
	The C$\flat$ Programming Language is mostly just a watered down version of C.
